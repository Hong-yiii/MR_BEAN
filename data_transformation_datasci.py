...
# Define the target longitude and latitude for which to calculate statistics
target_lon = -81.25  # Replace with your desired longitude
target_lat = 25.64631   # Replace with your desired latitude
...
# Plot each variable separately for mean and variance
for var in variables_of_interest:
    plt.figure(figsize=(8, 4))
    sns.barplot(x=['Mean', 'Variance'], y=[mean_values[var], variance_values[var]], palette='viridis')
    plt.title(f'Mean and Variance of {var} at Specified Lon/Lat')
